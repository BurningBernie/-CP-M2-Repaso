...
export const createHouse = (data) => {
  id = id + 1;
  data.id = id;
  return { type: CREATE_HOUSE, payload: data };
};

// Desde el componente ejecutamos la action creator, pasandole como argumento el id de la house que queremos eliminar.D
